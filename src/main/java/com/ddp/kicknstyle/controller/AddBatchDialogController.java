...
public class AddBatchDialogController {
    ...
    @FXML private ComboBox<String> batchStatusComboBox;
    @FXML private TableView<BatchDetailRow> batchDetailsTable;
    @FXML private TableColumn<BatchDetailRow, String> sneakerColumn;
    @FXML private TableColumn<BatchDetailRow, Integer> quantityColumn;
    @FXML private TableColumn<BatchDetailRow, Double> unitCostColumn;
    @FXML private Button addItemButton;
    @FXML private Button saveBatchButton;
    @FXML
    ...
    private void populateSupplierComboBox() {
        ...
        try (Connection conn = DatabaseConnection.getConnection();
             PreparedStatement pstmt = conn.prepareStatement("SELECT Supplier_Name FROM DPD_Supplier");
    ...
    private void setupBatchStatusComboBox() {
        ...
        batchStatusComboBox.setValue("In Stock");
    }
    ...
    private void saveBatch() {
        ...
        try {
            ...
            if (parentController != null) {
                parentController.loadBatchData();
            }
